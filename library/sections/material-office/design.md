...
- CTA `Copy Prompt` hanya berada di kartu katalog Framefield; dedicated preview tidak membawa CTA katalog.
...
- **CTA:** Kartu katalog Framefield menyediakan `Copy Prompt` dan menyalin master prompt code-first; dedicated preview hanya memiliki availability card dan `Back to library`.
...
- **Media paths:**
  ...
  - WebM R2: `https://assets.framefield.my.id/sections/material-office/hero-video.webm`
...
[x] Copy Prompt CTA added to catalog card only
